...
#--------------------------------------------------------------------
    ...
    #     ax2.plot([float(x) * duration / len(argmins) for x in range(0, len(argmins))], argmins)
    #     ax2.set_title('Index of minimums of CMND')
    #     ax2.set_ylabel('Frequency (Hz)')
    #     ax2.set_xlabel('Time (seconds)')
    #     ax3 = plt.subplot(3, 1, 3, sharex=ax2)
    #     ax3.plot([float(x) * duration / len(argmins) for x in range(0, len(argmins))],MED_output)
    #     ax3.set_title('Index of minimums of CMND_median')
